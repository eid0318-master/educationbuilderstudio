...
export default function SignupPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* 배경 데코레이션 */}
      <div className="fixed top-0 left-0 w-[500px] h-[500px] bg-cobalt-100/30 rounded-full blur-[120px] -z-10" />
      <div className="fixed bottom-0 right-0 w-[400px] h-[400px] bg-cobalt-50/40 rounded-full blur-[100px] -z-10" />
      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <div className="glass-card rounded-2xl p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">회원가입</h2>
            <p className="text-gray-400 mt-1 text-sm">강사 계정을 만들고 AI로 교육과정을 설계하세요</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              이미 계정이 있으신가요?{' '}
              <Link href="/login" className="text-cobalt-500 hover:text-cobalt-600 font-semibold transition-colors">
                로그인
              </Link>
            </p>
          </div>
